...
As alternative measures of TSO, the surveillance subscale of the Objectified Body Consciousness Scale [@mckinley1996objectified] and the Social Physique Anxiety [@hart1989tie] scales were also administered. An example item on the Objectified Body Consciousness Scale-surveillance (OBCS-surveillance) scale is *"During the day, I think about how I look many times."* OBCS-surveillance was reliable, $\alpha$ = 0.83. An example item from the Social Physique Anxiety (SPA) scale is *"Unattractive features of my physique/figure make me nervous in certain social settings,"* and this measure was also reliable, $\alpha$ = 0.91. 
