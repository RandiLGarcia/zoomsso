...
The sample was gathered at a Historically Women's College in the Northeast United states. To be included in the analyses participants needed to complete at least one daily diary measure. Of the 56 people who participated in the initial intake survey, 37 completed at least one daily diary measure and were included in the final sample. These 37 participants completed 172 total daily surveys with an average of 4.65 (SD = 0.89) surveys each (ranging from 1 to 5 surveys per person). 
...
Zoom_Use_Weekly, Zoom_Use_Daily,
